...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%1
	...
	\begin{figure}[H]
		\centering
		\caption{Porównanie dystrybuanty empirycznej i teoretycznej oraz wykres kwantylowy rozkładu Cauchy'ego $\mathcal{C}(0, 1)$ dla próby o długości $n = 1000$.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%3
	...
	\begin{figure}[H]
		\centering
		\caption{Porównanie dystrybuanty empirycznej i teoretycznej rozkładu Bernoulliego $\mathcal{B}(500, \frac{3}{10})$ dla próby o długości $n = 1000$.}
	...
	\begin{figure}[H]
		\centering
		\caption{Porównanie dystrybuanty empirycznej i teoretycznej oraz wykres kwantylowy rozkładu chi-kwadrat $\mathcal{X}^2(10)$ dla próby o długości $n = 1000$.}
